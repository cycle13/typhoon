...
if __name__ == '__main__':
    ...
    synth_dir = '20181026synth_redwhl_9models'
    ...
    # prit out prediction
    #for th in [0.8,0.81,0.82,0.83,0.84,0.841,0.842,0.843,0.844,0.845,0.846,0.847,0.848,0.849,0.85,0.855,0.86,0.87,0.88,0.89,0.90]:
    for th in [0.8485]:
        flg = 1 * (prob_TC > th)
        ...
        df.to_csv('%s/%s/pred_%s_th%4.5f.tsv' % (result_path,synth_dir,synth_dir,th), header=False, index=False, sep='\t')
