...
if __name__ == '__main__':
    cases = ['result_20181023_red_vgg19_lr001',
             ...
             'result_20181024_red_resnet50_rot',
             'result_20181024_red_resnet50_sample00',
             'result_20181024_red_resnet50_sample01',
             'result_20181024_red_resnet50_sample02',
             'result_20181024_red_resnet50_sample03',
...
#             'result_20181018_whl_resnext101_64'
    ...
    synth_dir = '20181025synth_red_7models'
    ...
    # prit out prediction
    for th in [0.8,0.81,0.82,0.83,0.84,0.841,0.842,0.843,0.844,0.845,0.85,0.853,0.855,0.857,0.86,0.87,0.873,0.875,0.878,0.88,0.89,0.90]:
        flg = 1 * (prob_TC > th)
